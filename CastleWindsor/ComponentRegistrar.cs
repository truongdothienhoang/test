namespace WebrootUI2.Web.Mvc.CastleWindsor
{
    ...
    public class ComponentRegistrar
    {
        ...
        private static void AddTasksTo(IWindsorContainer container)
        {
            container.Register(
                Classes
                    .FromAssemblyNamed("WebrootUI2.Tasks")
                    .Pick()
                    .WithService.FirstNonGenericCoreInterface("WebrootUI2.Domain"));
        }
        ...
        private static void AddCustomRepositoriesTo(IWindsorContainer container) 
        {
            container.Register(
                Classes
                    .FromAssemblyNamed("WebrootUI2.Infrastructure")
        ...
        {
            container.Register(
                Classes.FromAssemblyNamed("WebrootUI2.Web.Mvc")
                    .BasedOn<NHibernateQuery>()
                    .WithService.DefaultInterfaces());

            container.Register(
                Classes.FromAssemblyNamed("WebrootUI2.Infrastructure")
        ...
        {
            container.Register(
                Classes.FromAssemblyNamed("WebrootUI2.Tasks")
